...
export default class InternalErrorBoundary extends Component {
    constructor(props) {
        super(props)
                    ...
                    {this.state.alreadyReloaded ? (
                        <>
                            ...
                            <p style={{ fontSize: '14px', color: 'rgba(224,231,241,0.55)', marginBottom: '28px', lineHeight: 1.6 }}>
                                In the meantime, you can make this same change directly at{' '}
                                <a href="https://adk.sanity.studio" style={{ color: '#6daee0', textDecoration: 'none' }}>
                                    adk.sanity.studio
                                </a>
                                .
                            </p>
